...
public class Channel {
     ...
     * @see rss.generator.elem.Channel.Cloud
     ...
     * @see rss.generator.elem.Channel.Image
     ...
     * @see rss.generator.elem.Channel.TextInput
     ...
     * @see rss.generator.elem.Category 
     * @author Henrique A. Viecili
     */
    public class Category extends rss.generator.elem.Category {

        /** The Category constructor with the required param.
         * @exception InvalidRequiredParamException if some parameter passed is invalid
         * @see rss.generator.elem.Category#Category(String)
         ...
         * @exception InvalidRequiredParamException if some parameter passed is invalid
         * @see rss.generator.elem.Category#Category(String, String)
         * @param name The name of the category
